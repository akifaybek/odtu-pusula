  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-16">
        ...
        <p className="text-muted-foreground">Hoca bilgileri yükleniyor...</p>
      </div>
    );
  }
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-muted-foreground max-w-sm mb-4">
            Bu hoca için bilgi bulunamadı veya bir hata oluştu.
          </p>
          <Button onClick={fetchProfessorData}>Tekrar Dene</Button>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>•</span>
                <span>{professor.department.faculty}</span>
              </div>
